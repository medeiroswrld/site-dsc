...
export const MEDIA_SLOTS: MediaSlot[] = [
  ...
  {
    id: "showroom",
    label: "Salão de vendas",
    where: "Página Sobre",
    hint: "O interior da loja com os carros expostos.",
    kind: "image",
    aspect: "3 / 2",
    fallback: "/placeholders/showroom.svg",
    alt: `Salão da ${siteConfig.name}`,
  },
  {
    id: "team",
    label: "Equipe",
    where: "Página Sobre",
    hint: "A equipe reunida na loja. Foto de gente vende mais que foto de prédio.",
    kind: "image",
    aspect: "3 / 2",
    fallback: "/placeholders/team.svg",
    alt: `Equipe da ${siteConfig.name}`,
  },
  {
    id: "store_front",
